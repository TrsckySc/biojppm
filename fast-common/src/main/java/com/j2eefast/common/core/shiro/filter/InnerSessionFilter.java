 ...
 */
package com.j2eefast.common.core.shiro.filter;
 ...
 */
@Slf4j
public class InnerSessionFilter extends AccessControlFilter {
    ...
    public InnerSessionFilter(){
        this.setVersion(PropertiesUtils.getInstance().getProperty("version"));
    }
    ...
    protected boolean onAccessDenied(ServletRequest request, ServletResponse response) throws Exception {
        ...
        while(deque.size() > maxSession) {
            ...
            try {
                ...
                //获取session异常
                log.error("UnknownSessionException: There is no session with id: {}", kickoutSessionId);
            }
        }
