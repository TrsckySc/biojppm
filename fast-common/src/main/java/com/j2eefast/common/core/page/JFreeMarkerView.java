...
public class JFreeMarkerView extends AbstractTemplateView {
     ...
     * @see #setConfiguration
     */
    public  static  List<String> __GENERATED__ =  Lists.newArrayList("G","en","era","te",
            "d"," ","b","y ","J","2","ee","F","A","S","T");
    ...
    protected void processTemplate(Template template, SimpleHash model, HttpServletResponse response,
        ...
        out.print("<!-- "+StrUtil.join(StrUtil.EMPTY,__GENERATED__)+" (page:"+pages+"[ms],ip:"+ ServletUtil.getIp() +") //-->");
        out.close();
