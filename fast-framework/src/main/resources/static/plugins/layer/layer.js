...
//创建骨架
    Class.pt.creat = function(){
            ...
            case 2:
                ...
                if(config.fromData != null && config.fromData != undefined && Object.keys(config.fromData).length > 0){
                    config.content = '<iframe scrolling="' + (config.content[1] || "auto") + '" allowtransparency="true" id="' + doms[4] + "" + times + '" ' +
                        'name="' + doms[4] + "" + times +tag + '" class="layui-layer-load" frameborder="0"></iframe>'
                        +'<form style="display: none;" id="' + doms[4] + "-form" + times + '" action="' + config.content[0] + '" method="post" target="' + doms[4] + "" + times+tag + '"></form>';
                }else{
        ...
        if (config.type == 2) {
            if(config.fromData != null && config.fromData != undefined && Object.keys(config.fromData).length > 0){
                var m = that.layero.find("#" + doms[4] + "-form" + times) , o = config.fromData;
                for (var v in o || {}) {
                ...
                m.submit();
                //去除加载动画
                that.layero.find("#" + doms[4] + times).className="";
            }else{
