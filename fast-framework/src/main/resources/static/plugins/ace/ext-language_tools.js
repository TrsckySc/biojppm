...
(function() {
    ...
    this.parseSnippetFile = function(str) {
        ...
        if(!isTag){
            ...
            for(var i=0; i< str.snippetText.length; i++){
                snippet = {};
                snippet.content = str.snippetText[i].content;
                snippet.endRe = '/(?:)/';
                snippet.endTriggerRe = '/(?:)/';
                snippet.guard = '\\b';
                snippet.name = str.snippetText[i].snippet;
                snippet.scope = str.scope;
                snippet.startRe = '/\b(?:'+str.snippetText[i].snippet+')$/';
                snippet.tabTrigger = str.snippetText[i].snippet;
                snippet.trigger = str.snippetText[i].snippet;
                snippet.triggerRe = '/'+str.snippetText[i].snippet+'/';
                list.push(snippet);
            }
        }
         ...
         */
        // snippet = {};
        // snippet.content = '<@f.form name="${1:}">${2}</@f.form>';
        // snippet.endRe = '/(?:)/';
        // snippet.endTriggerRe = '/(?:)/';
        // snippet.guard = '\\b';
        // snippet.name = 'f.form';
        // snippet.scope = 'ftl';
        // snippet.startRe = '/\b(?:f.form)$/';
        // snippet.tabTrigger = 'f.form';
        // snippet.trigger = 'f.form';
        // snippet.triggerRe = '/f.form/';
        // list.push(snippet);
        console.log(list);
        return list;
    };
